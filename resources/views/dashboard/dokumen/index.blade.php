...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
  <div class="shadow p-3 mb-5 bg-body rounded">
    ...
    <div class="row">
      <div class="col-md-9">
        <a href="/kelola-dokumen/create" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Tambah Data"><img src="/img/add.svg" alt="" width="25px"></a>
      ...
      <table class="table table-bordered text-center">
        ...
        <tbody>
          <tr>
            ...
            <td>Pengumuman</td>
            <td>2024-02-02</td>
            <td><a href="/kelola-dokumen/update" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Ubah Data"><img src="/img/edit.svg" alt="" width="20px"></a></td>
