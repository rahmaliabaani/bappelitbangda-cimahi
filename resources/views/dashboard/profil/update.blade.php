...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
    <div class="shadow p-3 mb-5 bg-body rounded">
      ...
      <form action="/dashboard/profil/{{ $profil->id }}" method="POST" enctype="multipart/form-data">
        @method('put')
      @csrf
      <div class="row">
        <div class="col-lg-6">
          <div class="form-floating pb-3">
            <input type="text" class="form-control @error('periode') is-invalid @enderror" id="periode" name="periode" required placeholder="Periode" value="{{ old('periode', $profil->periode) }}">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="pb-3">
            ...
            @enderror
              <input id="tugas" type="hidden" name="tugas" required value="{{ old('tugas', $profil->tugas) }}">
        ...
        <div class="col-lg-6">
          <div class="pb-3">
            ...
            @error('tujuan')
              <p class="text-danger">{{ $message }}</p>
            @enderror
              <input id="tujuan" type="hidden" name="tujuan" required value="{{ old('tujuan', $profil->tujuan) }}">
        ...
        <div class="col-lg-6">
          <div class="pb-3">
            ...
            @error('fungsi')
              <p class="text-danger">{{ $message }}</p>
            @enderror
              <input id="fungsi" type="hidden" name="fungsi" required value="{{ old('fungsi', $profil->fungsi) }}">
        ...
        <div class="col-lg-6">
          <div class="pb-3">
            ...
            @error('sasaran')
              <p class="text-danger">{{ $message }}</p>
            @enderror
              <input id="sasaran" type="hidden" name="sasaran" required value="{{ old('sasaran', $profil->sasaran) }}">
        ...
        <div class="col-lg-6">
          <div class="pb-3">
            ...
            @error('sejarah')
              <p class="text-danger">{{ $message }}</p>
            @enderror
              <input id="sejarah" type="hidden" name="sejarah" required value="{{ old('sejarah', $profil->sejarah) }}">
